...
const METHODOLOGY_INFO = {
  animal: {
    ...
    icon: "🐲",
    content: `Валідизована проєктивна методика аналізу продуктів зображувальної діяльності.

    🧠 Когнітивний розвиток (БЛОК 1):
    Здійснюється виключно якісна оцінка (без числових балів, оскільки фігура людини відсутня). Аналізується структурна складність образу, логічність поєднання органів чуття і частин тіла, а також оригінальність задуму й творча уява.
    
    🎨 Емоційно-особистісні індикатори (БЛОК 2):
    Оцінюється тип побудови фігури, орієнтація голови (вектор активності), захисні та агресивні елементи (ікла, кігті, роги, панцир), енергетичні компоненти (крила, товщина опор лап, положення хвоста).`
  },
  house: {
    title: "«Будинок-дерево-людина» (HTP) (Дж. Бук)",
    icon: "🏠",
    content: `Валідизована проєктивна методика комплексного оцінювання графічної діяльності дитини.

    🧠 Когнітивний розвиток (БЛОК 1):
    Оцінюється за формалізованою 9-бальною бінарною шкалою тесту Ф. Гудінаф – Д. Гарріса для фігури людини: шия (7+ років), прикріплення рук до плечей, двовимірність кінцівок, зіниці, вуха, брови/вії, 5 пальців, непрозорість одягу, складні атрибути (0-3: низький; 4-6: середній/норма; 7-9: високий рівень).
    
    🎨 Емоційно-особистісні індикатори (БЛОК 2):
    Досліджуються проєктивні індикатори об'єктів:
    🏠 Будинок: відчуття захищеності, відкритості та психологічних меж.
    🌳 Дерево: життєвий ресурс, стійкість та емоційний тонус.
    🧍 Людина: сприйняття власного Я, емоційний контакт та соціальна адаптація.`
  }
};
                ...
                {isInfoOpen && (
                    <div className="px-5 pb-6 pl-14 animate-in fade-in slide-in-from-top-1 duration-200">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            >
                                <span className="text-2xl">🏠</span>
                                <span className="font-bold text-[#4B0082] text-lg">Будинок-дерево-людина (HTP)</span>
                            </button>
                        </div>
                    </div>
                )}
